            ...
            return (
                <React.Fragment>
                    <EditScrap
                        ...
                        initialValues={_.pick(this.props.portal, 'name', 'price', 'shoppingmall', 'delivery', 'description', 'redirectionLink')}
        ...
        return (
            <React.Fragment>
                ...
                <a href={this.props.portal.redirectionLink} target="_blank" rel="noopener noreferrer">
                    <img className="scrap-img" src={this.props.portal.favicon} alt={this.props.portal.name} />
                </a>
